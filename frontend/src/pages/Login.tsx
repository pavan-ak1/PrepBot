    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 px-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold bg-gradient-to-r from-teal-400 to-cyan-400 bg-clip-text text-transparent">Sign in to Job Prep</h2>
          <p className="mt-2 text-sm text-slate-400">
            Prepare for your next interview with AI-powered guidance
          </p>
        </div>
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            <Link to="/register" className="text-sm text-teal-400 hover:text-teal-300 transition-colors">
